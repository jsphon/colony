...
def save_prices(prices, auction_catalogue=None):
    print('save_prices received auction catalogue of %s' % str(auction_catalogue))
...
if __name__ == '__main__':
    ...
    get_prices_node = graph.add_node(get_prices,
                                     node_kwargs={'auction_catalogue': active_auctions_node})
    save_prices_node = graph.add_node(save_prices,
                                      node_args=(get_prices_node,),
                                      node_kwargs={'auction_catalogue': active_auctions_node})
